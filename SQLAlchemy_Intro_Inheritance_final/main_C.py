...
from menu_definitions import menu_main, add_menu, delete_menu, list_menu, semester_menu, schedule_menu, grade_menu, debug_select
...
def add_student_LetterGrade(sess):
    ...
    while not unique_student_section:
        ...
        if not unique_student_section:
            print("That section already has that student enrolled in it. Try again")
    grade = grade_menu.menu_prompt()
    letter_grade = LetterGrade(section, student, datetime.now(), grade)
